...
Ready to write API documentation? Work with real endpoints, practice writing request examples, and
learn response structures using a hands-on To-Do Service API.
...
and responses. The To-Do Service documentation uses Markdown, a simple text formatting system that's
easier to learn than HTML or other complex code.

## Quickstart ##

### Requesting information from the To-Do Service resources ###

The To-Do Service is an online task list that lets users create tasks and receive reminders. The
learning environment typically uses a local host server at `<http://localhost:3000>`.
